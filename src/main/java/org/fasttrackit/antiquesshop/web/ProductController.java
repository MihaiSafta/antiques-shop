package org.fasttrackit.antiquesshop.web;
...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<Page<Product>> getProduct(GetProductsRequest request, Pageable pageable){
        Page<Product> products = productService.getProducts(request, pageable);
        return new ResponseEntity<>(products, HttpStatus.OK);
    }
    @PutMapping("/{id}")
    public ResponseEntity<Product> updateProduct(@PathVariable ("id") long id, @RequestBody UpdateProductRequest request){
